...
void cmd_history(int argc, char *argv[]) {
    ...
    while ((entry = readdir(dir)) != NULL) {
        ...
        // STRICT CHECK: Commit objects generated by lit save MUST start with "timestamp " 
        // as their very first line, preventing random source code blobs from matching.
        if (strncmp(content, "timestamp ", 10) == 0 && strstr(content, "message ") != NULL) {
            commit_count++;
            ...
            // Parse timestamp
            char *ts_ptr = content; // We know it starts with timestamp 
